...
def welcome():
    ...
    if request.method == 'POST':
        ...
        basic_scatter_string,scatter_ids,basic_bar_string, bar_ids,basic_map_string, map_ids, world_map_string, world_map_ids  = tweets_senti_obj.search_tweets(name)
        ...
        return render_template('hello.html', form=form,
                               ...
                               worldPlot = world_map_string, world_map_ids = world_map_ids)
#==============================================================================
#         if form.validate():
...
@application.route('/electionresults', methods=['GET'])
def election_Tweets():
    elect_tweets = electionTweets()
    print("Inside")
    basic_scatter_string,scatter_ids,basic_bar_string, bar_ids,basic_map_string, map_ids,world_map_string, world_map_ids = elect_tweets.cal_election("ABC.txt")
